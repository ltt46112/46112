import ModalConfirmJoinQuiz from "../ModalConfirm";

interface IMainContentProps {
  onStartGame: (playerName: string) => void;
}

const MainContent = ({ onStartGame }: IMainContentProps) => {
  return (
    <main className="main">
      {/* Hero Section */}
        ...
        <div className="container">
          <div className="row gy-4">
            ...
            >
              ...
              <p>Nơi thử thách khả năng tập trung của bạn</p>
              <div className="d-flex">
                <ModalConfirmJoinQuiz onSubmit={onStartGame}>
                  <button className="btn-get-started">Start Game</button>
                </ModalConfirmJoinQuiz>
                <a
